...
const CONNECTOR_LABELS: Record<string, { name: string; hosts: string; desc?: string }> = {
  ...
  microsoft: {
    ...
    desc: "Lets the agent read and send your Outlook mail, manage your calendar and To Do, work with your OneDrive files, and read SharePoint sites on your behalf.",
  },
  x: {
    name: "X (Twitter)",
    hosts: "Posts & profile",
...
const CONNECTOR_LOGOS: Record<string, string> = {
  ...
  microsoft: "M0 0h11.377v11.372H0zm12.623 0H24v11.372H12.623zM0 12.628h11.377V24H0zm12.623 0H24V24H12.623z",
